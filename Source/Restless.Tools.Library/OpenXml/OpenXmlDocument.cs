...
namespace Restless.Tools.OpenXml
{
    ...
    public static class OpenXmlDocument
    {
        ...
        public static class Reader
        {
            ...
            {
                Validations.ValidateNullEmpty(fileName, "GetText.FileName");
                Validations.ValidateInvalidOperation(!File.Exists(fileName), Strings.InvalidOperation_CannotOpenFile);
                try
                {
                    string result = null;
                ...
                {
                    throw new InvalidOperationException(Strings.InvalidOperation_OpenXmlReader);
                }
            }
        ...
        public static class Writer
        {
            ...
            {
                Validations.ValidateNullEmpty(fileName, "SetCoreProperties.FileName");
                Validations.ValidateInvalidOperation(!File.Exists(fileName), Strings.InvalidOperation_CannotOpenFile);
                Validations.ValidateNull(props, "SetCoreProperties.Props");
                try
                {
